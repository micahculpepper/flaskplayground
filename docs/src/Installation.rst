...
.. highlight:: none
.. include:: ../../flaskplayground.egg-info/requires.txt
   :literal:
...
1. `Download the latest release here <https://github.com/micahculpepper/flaskplayground/releases/latest>`_.
...
|package| releases are provided in the form of `setuptools <http://setuptools.readthedocs.io>`_ source distributions.
This format, while somewhat trickier to install than an executable binary, facilitates collaboration
by ensuring that all users have the full source code available in their library.
